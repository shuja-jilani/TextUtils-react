...
export default function Navbar(props) {
  ...
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Enable Blue Dark Mode</label>
        ...
        <div className={`mx-2 form-check form-switch text-${props.mode==='light'?'danger':'light'}`}>
  ...
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Enable Red Dark Mode</label>
        ...
        <div className={`mx-2 form-check form-switch text-${props.mode==='light'?'success':'light'}`}>
  ...
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Enable Green Dark Mode</label>
        ...
        <div className={`mx-2 form-check form-switch text-${props.mode==='light'?'purple':'light'}`}>
...
Navbar.propTypes = { //proptypes ka kaam h prop ka datatype set krna 
    title: PropTypes.string.isRequired, //isrequired h agr aur nhi dala to error
    aboutText: PropTypes.string.isRequired
}

Navbar.defaultProps = { //agar by chance props bheje hi nhi to 
